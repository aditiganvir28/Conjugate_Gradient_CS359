...
int main(){
    ...
    x_out = solver_sequential(A,Arow,Acol,b,describe,assume_psd,iterations,epsilon);

    cout<<"Parallel Implementation : "<<endl;

    x_out=solver_parallel(A,Arow,Acol,b,describe,assume_psd,iterations,epsilon);
